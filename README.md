...
[![Build Status](https://img.shields.io/jenkins/build?jobUrl=https%3A%2F%2Fci.blamejared.com%2Fjob%2Fmezz%2Fjob%2FJavaFormatting%2Fview%2Ftags%2Fjob%2Fv0.2.2%2F&label=build)](https://ci.blamejared.com/job/mezz/job/JavaFormatting/view/tags/job/v0.2.2/)
...
```kotlin
plugins {
	id("net.mezzdev.java-formatting") version "0.2.2"
}
```
